# Django settings for minimalUpload project.
...
SECRET_KEY = '@vdu$+(3a0#0%77gjxv87r5$@i#k@olq_$!8lcgb7ifqb^4rwc'
...
ROOT_URLCONF = 'minimalUpload.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'minimalUpload.wsgi.application'
